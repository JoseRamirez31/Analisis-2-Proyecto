...
* The original package name 'com.prueba.login-system' is invalid and this project uses 'com.prueba.login_system' instead.
...
* [Validation](https://docs.spring.io/spring-boot/3.5.6-SNAPSHOT/reference/io/validation.html)
